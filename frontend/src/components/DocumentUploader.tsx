...
//   const uploadFile = async () => {
//     setButtonStatus("uploading");
//     // Assume your API.get call is correctly fetching a presigned URL
//     await API.get("serverless-pdf-chat", "/generate_presigned_url", {
//       headers: { "Content-Type": "application/json" },
//       queryStringParameters: {
//         file_name: selectedFile?.name,
...
//       <h2 className="text-2xl font-bold pb-4 dark:text-white">Add document</h2>
//       {inputStatus === "idle" && (
//         <div className="flex items-center justify-center w-full">
//           <label
//             htmlFor="dropzone-file"
...
//           >
//             <div className="flex flex-col items-center justify-center pt-5 pb-6">
//               <CloudArrowUpIcon className="w-12 h-12 mb-3 text-gray-400 dark:text-gray-300" />
//               <p className="mb-2 text-sm text-gray-500 dark:text-gray-300">
//                 <span className="font-semibold">Click to upload</span> your
//                 document
//               </p>
//               <p className="text-xs text-gray-500 dark:text-gray-300">Only .pdf accepted</p>
//             </div>
//             <input
//               onChange={handleFileChange}
//               id="dropzone-file"
...
//       {inputStatus === "valid" && (
//         <div className="flex items-center justify-center w-full">
//           <div className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
//             <>
//               <div className="flex flex-row items-center mb-5">
//                 <DocumentIcon className="w-14 h-14 text-gray-400 dark:text-gray-300" />
//                 <div className="flex flex-col ml-2">
//                   <p className="font-bold mb-1 dark:text-white">{selectedFile?.name}</p>
...
//                   onClick={resetInput}
//                   type="button"
//                   className="inline-flex items-center text-gray-900 dark:text-white bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg px-3 py-2 text-sm mr-2 mb-2 dark:bg-gray-600 dark:border-gray-500 dark:hover:bg-gray-500 dark:focus:ring-gray-700"
//                 >
//                   <XCircleIcon className="w-5 h-5 mr-1.5" />
//                   Cancel
//                 </button>
...
//                     onClick={uploadFile}
//                     type="button"
//                     className="inline-flex items-center bg-violet-900 text-white border border-gray-300 focus:outline-none hover:bg-violet-700 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg px-3 py-2 text-sm mr-2 mb-2 dark:border-gray-500 dark:hover:bg-violet-600 dark:focus:ring-violet-700"
//                   >
//                     <CloudArrowUpIcon className="w-5 h-5 mr-1.5" />
//                     Upload document
//                   </button>
//                 )}
//                 {/* Consider adding dark mode styles for other button states */}
//               </div>
//             </>
//           </div>
//         </div>
