...
// }) => {
//   return (
//     <div className="col-span-4 h-full dark:bg-gray-800">
//       <div className="bg-gray-100 p-5 dark:bg-gray-700">
//         <DocumentDetail {...conversation.document} />
//       </div>
//       <div className="px-3 pt-3 pb-5 dark:bg-gray-800">
//         {conversationListStatus === "idle" && (
//           <button
//             onClick={addConversation}
//             className="bg-gray-50 w-full inline-flex items-center px-4 py-2.5 border border-gray-100 rounded hover:bg-gray-200 dark:bg-gray-600 dark:border-gray-700 dark:hover:bg-gray-500 dark:text-gray-300"
//           >
//             <PlusCircleIcon className="w-4 h-4 mr-2" />
//             Start a new conversation
//           </button>
...
//               aria-hidden="true"
//               role="status"
//               className="inline w-4 h-4 mr-2 text-gray-200 animate-spin dark:text-gray-400"
//               viewBox="0 0 100 101"
//               fill="none"
//               xmlns="http://www.w3.org/2000/svg"
//             >
...
//                     params.conversationid === conversation.conversationid
//                   }
//                   className="bg-gray-500 text-white w-full inline-flex items-center mt-2 px-4 py-2.5 border border-gray-100 rounded dark:bg-gray-600 dark:text-gray-300"
//                 >
//                   <ChatBubbleLeftRightIcon className="w-4 h-4 mr-2" />
//                   {getDateTime(conversation.created)}
//                 </button>
...
//                     params.conversationid === conversation.conversationid
//                   }
//                   className="bg-gray-50 w-full inline-flex items-center mt-2 px-4 py-2.5 border border-gray-100 rounded hover:bg-gray-200 dark:bg-gray-600 dark:border-gray-700 dark:hover:bg-gray-500 dark:text-gray-300"
//                 >
//                   <ChatBubbleLeftRightIcon className="w-4 h-4 mr-2" />
//                   {getDateTime(conversation.created)}
//                 </button>
